...
> = {
  createPost?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationCreatePostArgs, "content" | "userId">
  >;
  createUser?: Resolver<
    ResolversTypes["User"],
    ParentType,
  ...
  updatePost?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationUpdatePostArgs, "content" | "id">
  >;
};
...
> = {
  ...
  postDetail?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryPostDetailArgs, "postId">
  >;
  searchPosts?: Resolver<
    Array<Maybe<ResolversTypes["Post"]>>,
    ParentType,
    ContextType,
    RequireFields<QuerySearchPostsArgs, "word">
  >;
  userPosts?: Resolver<
    Array<Maybe<ResolversTypes["Post"]>>,
    ParentType,
